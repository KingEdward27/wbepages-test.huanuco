...
/***/ "./resources/assets/js/pagina-web/publicaciones/revistas.js":
...
new Vue({
    ...
    methods: {
        getCategorias: function getCategorias() {
            ...
            var url = '/api/web/revistas/categorias';
            axios.get(url).then(function (response) {
                _this.categorias = response.data;
            });
        },
        getDatos: function getDatos(id) {
            var _this2 = this;

            this.table = !this.table;
            this.showInter = false;
            var url = '/api/web/revistas/listar/' + id;
            axios.get(url).then(function (response) {
                _this2.datoslistar = response.data;
                _this2.datosPaginar = response.data;
                _this2.changePage(1);
            });
        },
...
module.exports = __webpack_require__("./resources/assets/js/pagina-web/publicaciones/revistas.js");
